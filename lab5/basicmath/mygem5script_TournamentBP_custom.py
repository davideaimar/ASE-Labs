...
def create_cpu(options, cpu_id):
    ...
    the_cpu.LQEntries = 64
    the_cpu.SQEntries = 64
    ...
    # the_cpu.branchPred = my_predictor
    my_predictor = TournamentBP()
    my_predictor.localPredictorSize = 64
    my_predictor.localHistoryTableSize = 512
    my_predictor.globalPredictorSize = 128
    my_predictor.choicePredictorSize = 128
    my_predictor.BTBEntries = 512
    the_cpu.branchPred = my_predictor
    ...
    # ********************************
    # -- FUNTIONAL UNITS DEFINITION  -> to edit
    # ********************************
